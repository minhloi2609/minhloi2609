              ...
              <div class="flex flex-wrap flex-row lg:justify-between -mx-3">
                  <div class="flex-shrink max-w-full w-full lg:w-2/5 px-3 lg:pr-16">
                      <div class="flex items-center mb-2">
                          <span class="text-3xl leading-normal mb-2 font-bold text-gray-100 mt-2">THỂ THAO 24h</span>
                  ...
                  <div class="flex-shrink max-w-full w-full lg:w-3/5 px-3">
                      <div class="flex flex-wrap flex-row">
                          <div class="flex-shrink max-w-full w-1/2 md:w-1/4 mb-6 lg:mb-0">
                              <h4 class="text-base leading-normal mb-3 uppercase text-gray-100">Sản phẩm</h4>
                              <ul>
                                  <li class="py-1 hover:text-white"><a href="#">Trang đích</a></li>
                                  <li class="py-1 hover:text-white"><a href="#">Trang</a></li>
                                  <li class="py-1 hover:text-white"><a href="#">Phần</a></li>
                                  <li class="py-1 hover:text-white"><a href="#">Đăng ký</a></li>
                                  <li class="py-1 hover:text-white"><a href="#">Đăng nhập</a></li>
                              </ul>
                          </div>
                          <div class="flex-shrink max-w-full w-1/2 md:w-1/4 mb-6 lg:mb-0">
                              <h4 class="text-base leading-normal mb-3 uppercase text-gray-100">Hỗ trợ</h4>
                              <ul>
                                  <li class="py-1 hover:text-white"><a href="#">Tài liệu</a></li>
                                  <li class="py-1 hover:text-white"><a href="#">Nhật ký thay đổi</a></li>
                                  <li class="py-1 hover:text-white"><a href="#">Công cụ</a></li>
                                  <li class="py-1 hover:text-white"><a href="#">Biểu tượng</a></li>
                              </ul>
                          </div>
                          <div class="flex-shrink max-w-full w-1/2 md:w-1/4 mb-6 lg:mb-0">
                              <h4 class="text-base leading-normal mb-3 uppercase text-gray-100">Bao gồm</h4>
                              <ul>
                                  <li class="py-1 hover:text-white"><a href="#">Tiện ích</a></li>
                                  <li class="py-1 hover:text-white"><a href="#">Thành phần</a></li>
                                  <li class="py-1 hover:text-white"><a href="#">Mã ví dụ</a></li>
                                  <li class="py-1 hover:text-white"><a href="#">Cập nhật</a></li>
                              </ul>
                          </div>
                          <div class="flex-shrink max-w-full w-1/2 md:w-1/4 mb-6 lg:mb-0">
                              <h4 class="text-base leading-normal mb-3 uppercase text-gray-100">Pháp lý</h4>
                              <ul>
                                  <li class="py-1 hover:text-white"><a href="#">Chính sách bảo mật</a></li>
                                  <li class="py-1 hover:text-white"><a href="#">Điều khoản sử dụng</a></li>
                                  <li class="py-1 hover:text-white"><a href="#">Giấy phép</a></li>
          ...
          <div class="container py-4 border-t border-gray-200 border-opacity-10">
              <div class="row">
                  <div class="col-12 col-md text-center">
                      <p class="d-block my-3">Copyright ©| Lointmpd08035.</p>
                  </div>
              </div>
          </div>
