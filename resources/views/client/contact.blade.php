                ...
                <div class="flex-shrink max-w-full w-full lg:w-2/3  overflow-hidden">
                    <div class="w-full py-3">
                        <h2 class="text-gray-800 text-3xl font-bold">
                            <span class="inline-block h-5 border-l-3 border-red-600 mr-2"></span> Liên hệ với chúng tôi
                        </h2>
                    </div>
                            ...
                            <div class="px-8 py-6 border border-gray-100 bg-white">
                                <form class="flex flex-wrap flex-row -mx-4">
                                    <div class="flex-shrink max-w-full px-4 w-full md:w-1/2 mb-6">
                                        <label for="inputfirst4" class="inline-block mb-2">Tên</label>
                                    ...
                                    <div class="flex-shrink max-w-full px-4 w-full md:w-1/2 mb-6">
                                        <label for="inputlast4" class="inline-block mb-2">Họ</label>
                                    ...
                                    <div class="flex-shrink max-w-full px-4 w-full md:w-1/2 mb-6">
                                        <label for="inputurgent" class="inline-block mb-2">Mức độ khẩn cấp</label>
                                    ...
                                    <div class="flex-shrink max-w-full px-4 w-full mb-6">
                                        <label for="exampleTextarea1" class="inline-block mb-2">Ghi Chú</label>
                                    ...
                                    <div class="flex-shrink max-w-full px-4 w-full mb-6">
                                        <label class="flex items-center">
                                            ...
                                            <span class="text-gray-700 ml-4">Tôi đồng ý với Điều khoản sử dụng</span>
                                        </label>
                                    </div>
